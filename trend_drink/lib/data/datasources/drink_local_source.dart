...
class DrinkLocalSource {
  ...
  static const List<DrinkModel> _drinks = [
    ...
    DrinkModel(
      id: 'homemade-iced-mocha',
      title: 'Ev Yapımı Soğuk Mocha',
      category: 'Kahve',
      description: 'Evdeki malzemelerle hazırlanan, çikolata ve kahvenin serinletici uyumu.',
      history: 'Kafelerde popüler olan mocha tarifinin, evdeki kakao ve hazır kahveyle yapılabilen ekonomik ve pratik bir versiyonudur.',
      temperature: 'Soğuk',
      pros: ['Ekonomik', 'Tatlı ihtiyacını giderir', 'Hızlı hazırlanır'],
      cons: ['Şeker içeriği kontrol edilmeli'],
      tip: 'Kakaoyu az miktarda sıcak suyla eritirseniz topaklanma yapmaz.',
      preparation: '1. 1 tatlı kaşığı kahve ve 1 tatlı kaşığı kakaoyu az miktarda sıcak suda eritin.\n2. İçine 1 tatlı kaşığı bal veya şeker ekleyin.\n3. Bardağı buzla doldurun.\n4. Üzerine 1 bardak soğuk süt ekleyin ve karıştırın.',
      ingredients: ['kahve', 'kakao', 'süt', 'bal', 'buz'],
      imageUrl: 'Assets/Categories/kahve/iced mocha.jpg',
      gradient: LinearGradient(colors: [Color(0xFF3E2723), Color(0xFF795548)]),
    ),
    DrinkModel(
      id: 'honey-ginger-lemon-tea',
      title: 'Ballı Zencefilli Limon Çayı',
      category: 'Çay',
      description: 'Bağışıklık dostu, tazeleyici ve ısıtan klasik bir kış çayı.',
      history: 'Anadolu mutfağında "şifa çayı" olarak bilinen bu karışım, taze zencefilin keşfiyle modern mutfakların vazgeçilmezi olmuştur.',
      temperature: 'Sıcak',
      pros: ['Boğazı rahatlatır', 'C vitamini kaynağı', 'Metabolizmayı hızlandırır'],
      cons: ['Taze zencefilin tadı bazıları için keskin gelebilir'],
      tip: 'Balı, çay biraz ılıdıktan sonra eklerseniz besin değerini kaybetmez.',
      preparation: '1. Taze zencefili ince dilimleyin.\n2. 1 bardak suda 5 dakika kaynatın.\n3. Fincana alıp içine yarım limon sıkın.\n4. Biraz ılınınca 1 tatlı kaşığı bal ekleyip karıştırın.',
      ingredients: ['zencefil', 'limon', 'bal', 'su'],
      imageUrl: 'Assets/Categories/çay/ginger lemon.jpg',
      gradient: LinearGradient(colors: [Color(0xFFFFD54F), Color(0xFFFBC02D)]),
    ),
    DrinkModel(
      id: 'strawberry-mint-lemonade',
      title: 'Çilekli Naneli Limonata',
      category: 'Soda',
      description: 'Taze çilek püresi ve ferahlatıcı nane ile zenginleştirilmiş ev yapımı limonata.',
      history: 'Geleneksel limonatanın, meyve pazarlarındaki taze çileklerle modernize edilmiş bir versiyonudur.',
      temperature: 'Soğuk',
      pros: ['Ultra ferahlatıcı', 'Görsel olarak şık', 'Çocuklar için sağlıklı alternatif'],
      cons: ['Çileklerin ayıklanması vakit alabilir'],
      tip: 'Naneleri elinizle hafifçe patlatarak (vurarak) eklerseniz aroması daha güçlü çıkar.',
      preparation: '1. 5-6 adet çileği bir çatalla veya blenderla ezin.\n2. 1 adet limonun suyunu ekleyin.\n3. 1 yemek kaşığı şeker veya bal ile tatlandırın.\n4. Üzerine soğuk su veya soda ekleyip taze nane yapraklarıyla süsleyin.',
      ingredients: ['çilek', 'limon', 'nane', 'su', 'buz'],
      imageUrl: 'Assets/Categories/soda/strawberry mint.jpg',
      gradient: LinearGradient(colors: [Color(0xFFF06292), Color(0xFFE91E63)]),
    ),
    DrinkModel(
      id: 'oat-apple-smoothie',
      title: 'Yulaflı Elmalı Smoothie',
      category: 'Smoothie',
      description: 'Elma ve tarçın kokulu, doyurucu bir kahvaltı smoothie\'si.',
      history: 'Hızlı kahvaltı kültürünün bir parçası olarak ortaya çıkan bu tarif, elmalı turtanın içilebilir ve sağlıklı hali gibidir.',
      temperature: 'Soğuk',
      pros: ['Yüksek lifli', 'Uzun süre tok tutar', 'Enerji verir'],
      cons: ['Kıvamı bekledikçe koyulaşabilir'],
      tip: 'Yulafları önceden sütte 5 dakika bekletirseniz daha pürüzsüz bir kıvam elde edersiniz.',
      preparation: '1. 1 adet elmayı soyup dilimleyin.\n2. 3 yemek kaşığı yulaf ezmesi, 1 bardak süt ve bir tutam tarçın ekleyin.\n3. Tüm malzemeleri blenderda pürüzsüz olana kadar çekin.',
      ingredients: ['elma', 'yulaf', 'süt', 'tarçin'],
      imageUrl: 'Assets/Categories/smoothie/apple oat.jpg',
      gradient: LinearGradient(colors: [Color(0xFFAED581), Color(0xFF8BC34A)]),
    ),
    DrinkModel(
      id: 'minty-ayran-classic',
      title: 'Naneli Ev Yapımı Ayran',
      category: 'Fit',
      description: 'Yemeklerin yanına en çok yakışan, bol köpüklü ve naneli ferahlık.',
      history: 'Binlerce yıllık Orta Asya geleneği olan ayranın, ferahlatıcı taze nane ile buluşmuş modern sunumudur.',
      temperature: 'Soğuk',
      pros: ['Doğal probiyotik', 'Tansiyon dengeleyici', 'Sindirime yardımcı'],
      cons: ['Tuz oranı tansiyon hastalarınca dikkatli tüketilmelidir'],
      tip: 'Ayranı hazırlarken içine bir parça maden suyu eklerseniz daha köpüklü ve hafif olur.',
      preparation: '1. 3 yemek kaşığı yoğurdu bardağa alın.\n2. Üzerine biraz su ve bir tutam tuz ekleyin.\n3. Kurutulmuş veya taze nane ekleyerek iyice çalkalayın veya çırpın.\n4. Soğuk servis edin.',
      ingredients: ['yoğurt', 'su', 'nane', 'tuz'],
      imageUrl: 'Assets/Categories/fit/ayran.jpg',
      gradient: LinearGradient(colors: [Color(0xFFE0E0E0), Color(0xFFF5F5F5)]),
    ),
    DrinkModel(
      id: 'classic-homemade-lemonade',
      title: 'Klasik Ev Yapımı Limonata',
      category: 'Soda',
      description: 'Geleneksel yöntemle hazırlanan, ferahlatıcı ve doğal limonata.',
      temperature: 'Soğuk',
      pros: ['C vitamini deposu', 'Tamamen doğal', 'Harareti alır'],
      cons: ['Şeker oranı isteğe göre ayarlanmalı'],
      tip: 'Limon kabuklarını şekerle ovarsanız aroması çok daha güçlü çıkar.',
      preparation: '1. 4 adet limonun kabuğunu rendeleyin ve şekerle ovun.\n2. Limonların suyunu sıkıp karışıma ekleyin.\n3. 1 litre su ilave edip şeker eriyene kadar karıştırın.\n4. Süzerek buzla servis edin.',
      ingredients: ['limon', 'şeker', 'su', 'buz'],
      imageUrl: 'Assets/Categories/soda/classic lemonade.jpg',
      gradient: LinearGradient(colors: [Color(0xFFFFF176), Color(0xFFFBC02D)]),
    ),
    DrinkModel(
      id: 'white-chocolate-mocha',
      title: 'White Chocolate Mocha',
      category: 'Kahve',
      description: 'Beyaz çikolatanın kremsi tadı ile espressonun buluşması.',
      temperature: 'Sıcak',
      pros: ['Yumuşak içim', 'Enerji verici', 'Tatlı ihtiyacını karşılar'],
      cons: ['Kalorisi yüksektir'],
      tip: 'Üzerine biraz rendelenmiş beyaz çikolata ekleyerek sunumu zenginleştirebilirsiniz.',
      preparation: '1. 2 yemek kaşığı beyaz çikolata sosunu bardağa alın.\n2. Üzerine 1 shot taze espresso ekleyip karıştırın.\n3. Isıtılmış ve köpürtülmüş sütü ilave edin.',
      ingredients: ['espresso', 'süt', 'beyaz çikolata'],
      imageUrl: 'Assets/Categories/kahve/white chocolate mocha.jpg',
      gradient: LinearGradient(colors: [Color(0xFFF5F5F5), Color(0xFFD7CCC8)]),
    ),
    DrinkModel(
      id: 'moroccan-mint-tea',
      title: 'Fas Usulü Naneli Çay',
      category: 'Çay',
      description: 'Yeşil çay ve taze nanenin geleneksel ve aromatik uyumu.',
      temperature: 'Sıcak',
      pros: ['Sindirim dostu', 'Rahatlatıcı', 'Ferahlatıcı aroma'],
      cons: ['Şekerli tüketimi yaygındır'],
      tip: 'Çayı yüksekten dökerek bardağın üzerinde köpük oluşmasını sağlayın.',
      preparation: '1. Demliğe yeşil çay ve taze nane yapraklarını koyun.\n2. Üzerine sıcak su ekleyip 5 dakika demleyin.\n3. Bol şeker (isteğe bağlı) ekleyerek servis edin.',
      ingredients: ['yeşil çay', 'nane', 'su', 'şeker'],
      imageUrl: 'Assets/Categories/çay/moroccan mint tea.jpg',
      gradient: LinearGradient(colors: [Color(0xFF81C784), Color(0xFF2E7D32)]),
    ),
    DrinkModel(
      id: 'forest-fruit-smoothie',
      title: 'Orman Meyveleri Smoothie',
      category: 'Smoothie',
      description: 'Yaban mersini, ahududu ve böğürtlenin antioksidan gücü.',
      temperature: 'Soğuk',
      pros: ['Antioksidan zengini', 'Vitamin deposu', 'Düşük kalorili'],
      cons: ['Meyve çekirdekleri rahatsız edebilir'],
      tip: 'Dondurulmuş meyve kullanmak daha koyu bir kıvam sağlar.',
      preparation: '1. Karışık orman meyvelerini blenderda çekin.\n2. Yarım bardak yoğurt ve az miktar süt ekleyin.\n3. Pürüzsüz olana kadar karıştırmaya devam edin.',
      ingredients: ['yaban mersini', 'ahududu', 'böğürtlen', 'yoğurt', 'süt'],
      imageUrl: 'Assets/Categories/smoothie/forest fruit smoothie.jpg',
      gradient: LinearGradient(colors: [Color(0xFF880E4F), Color(0xFFAD1457)]),
    ),
    DrinkModel(
      id: 'iced-jasmine-green-tea',
      title: 'Soğuk Yaseminli Yeşil Çay',
      category: 'Çay',
      description: 'Hafif yasemin kokulu, ferahlatıcı soğuk yeşil çay.',
      temperature: 'Soğuk',
      pros: ['Metabolizmayı hızlandırır', 'Hafif içim', 'Doğal aromalı'],
      cons: ['Aç karnına içildiğinde mide hassasiyeti yapabilir'],
      tip: 'İçine bir dilim taze elma ekleyerek tatlılık katabilirsiniz.',
      preparation: '1. Yaseminli yeşil çayı sıcak suda 3 dakika demleyip süzün.\n2. Oda sıcaklığına gelince buz ekleyerek soğutun.\n3. Limon dilimi ile servis edin.',
      ingredients: ['yeşil çay', 'yasemin', 'buz', 'limon'],
      imageUrl: 'Assets/Categories/çay/jasmine tea.jpg',
      gradient: LinearGradient(colors: [Color(0xFFC8E6C9), Color(0xFF4CAF50)]),
    ),
    DrinkModel(
      id: 'espresso-tonic',
      title: 'Espresso Tonic',
      category: 'Kahve',
      description: 'Espressonun yoğunluğu ile toniğin ferahlatıcı asiditesi.',
      temperature: 'Soğuk',
      pros: ['Sıradışı bir ferahlık', 'Düşük kalorili kahve seçeneği', 'Modern lezzet'],
      cons: ['Tonik suyunun acımsı tadı herkese hitap etmeyebilir'],
      tip: 'Espressoyu toniğin üzerine yavaşça dökerek katmanlı bir görüntü oluşturun.',
      preparation: '1. Bardağı buzla doldurun.\n2. Üzerine 150 ml tonik su ekleyin.\n3. En üste 1 shot taze espressoyu yavaşça dökün.\n4. Bir dilim limon veya biberiye dalı ile süsleyin.',
      ingredients: ['espresso', 'tonik', 'buz', 'limon'],
      imageUrl: 'Assets/Categories/kahve/espresso tonic.jpg',
      gradient: LinearGradient(colors: [Color(0xFF212121), Color(0xFFFFA000)]),
    ),
  ];
}
